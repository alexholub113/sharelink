const SupportedLinksInfoAlert = () => (
    <div className="flex p-4 text-sm rounded-lg card-dark secondary-text-color" role="alert">
...
export default SupportedLinksInfoAlert;
