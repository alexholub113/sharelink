...
const UserMenu = observer(({ onClose }: UserMenuProps) => {
    ...
    return (
        <div ref={refObject} className="absolute right-10 z-10 dark-border divide-y rounded-lg shadow w-44 dark-background dark:divide-zinc-600 secondary-text-color">
