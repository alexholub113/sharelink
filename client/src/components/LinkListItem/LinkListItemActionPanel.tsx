...
import DislikeLinkActionButton from './ActionButtons/DislikeLinkActionButton.tsx';
...
const LinkListItemActionPanel = ({ link, disabled, updating, onCancelClick, onEditClick}: LinkListItemActionPanelProps) => {
    return (
        <div className="flex flex-row justify-between secondary-text-color">
            <div className="flex flex-row gap-4">
                <LikeLinkActionButton {...link} />
                <DislikeLinkActionButton {...link} />
            </div>
