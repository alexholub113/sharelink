...
public static class CommandServiceCollectionExtensions
{
        ...
        CommandDescriptor descriptor)
    {
        ...
        var existingDescriptor = services.FirstOrDefault(s => s.ImplementationInstance is CommandDescriptor d &&
    ...
    {
        var defaultNotValidMethod = typeof(CommandServiceCollectionExtensions)
