...
- To add migration `dotnet ef migrations add AddedDislikes --context ApplicationDbContext --output-dir Migrations/ApplicationMigrations -- "../ShareLink.Web/appsettings.json"` from from `src\ShareLink.Migrations`
